...
# Creates a py file from the ipynb source file.
# The purpose of this file is to demonstrate research only,
# the .ipynb file no longer exists and the program is run only as a py file now.
